...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        String result = mingApiClient.getUserNameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        MingApiClient tmpClient = new MingApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.ming.mingapiclientsdk.model.User jsonUser = gson.fromJson(userRequestParams, com.ming.mingapiclientsdk.model.User.class);
        String result = tmpClient.getUserNameByPost(jsonUser);
        return ResultUtils.success(result);
    }
